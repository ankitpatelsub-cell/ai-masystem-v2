...
router.post('/:id/draft-personal', requirePerm('leads:manage'), async (req,res)=>{
  ...
  const draft = await runAgent(
    'You are the MASystem outreach agent. Write a SHORT, warm, business-SPECIFIC outreach email body (no subject/headers). Reference the lead’s actual name, segment, and city. Offer a 5-minute demo. Under 130 words.',
